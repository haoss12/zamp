...
void XMLInterp4Config::ProcessCubeAttrs(const xercesc::Attributes &rAttrs)
{
    ...
    {
        cout << " Czytanie wartosci przesuniecia OK!!!" << endl;
        cout << "     " << x << "  " << y << "  " << z << endl;
    }
    ...
    {
        cout << " Czytanie wartosci skali OK!!!" << endl;
        cout << "     " << x << "  " << y << "  " << z << endl;
    }
    ...
    IStrm >> x >> y >> z;
    cuboid.SetAng_Roll_deg(x);
    cuboid.SetAng_Pitch_deg(y);
    cuboid.SetAng_Yaw_deg(z);
    if (IStrm.fail())
    {
        cerr << " Blad!!!" << endl;
    }
    ...
    {
        cout << " Czytanie wartosci RPY OK!!!" << endl;
        cout << "     " << x << "  " << y << "  " << z << endl;
    }
    ...
    {
        cout << " Czytanie wartosci kolorow OK!!!" << endl;
        cout << "     " << r << "  " << g << "  " << b << endl;
    }
    IStrm.clear();

    _config._mobileObjs.push_back(cuboid);
 ...
 */
void XMLInterp4Config::startElement(const XMLCh *const pURI, const XMLCh *const pLocalName, const XMLCh *const pQName,
